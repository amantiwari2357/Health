...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login - SW Healthcare</title>
        <meta
          name="description"
          content="Login to your SW Healthcare account to access your dashboard and manage your health products. If you're new, create an account to get started with our premium healthcare solutions."
        />
      </Helmet>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 register_responsive text-center">
              <div className="signup">
                ...
                <hr />
                <p className="register-heading">Register for SW Healthcare</p>
                <p className="register-info">
                  By creating an account, you will enjoy easy access to our
                  premium health products, track your orders, and receive the
                  latest updates on new healthcare solutions.
                </p>
