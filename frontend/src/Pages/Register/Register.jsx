...
const Register = () => {
    ...
    try {
      if (data.password === cPass) {
        const res = await axios.post(
          "https://health-4-xkdr.onrender.com/api/signup",
          data
        );
        if (res.status === 201) {
          Swal.fire({
  ...
  return (
    <>
      <Helmet>
        <title>Register - Create Your SW Healthcare Account</title>
        <meta
          name="description"
          content="Sign up to create an account with SW Healthcare and gain access to our wide range of health products. Join now to shop premium healthcare solutions and track your orders."
        />
      </Helmet>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 register_responsive text-center">
              <div className="signup">
                <h3 className="new-customer">
                  Login to Your SW Healthcare Account
                </h3>
                <hr />
                <p className="register-info">
                  If you already have an account with SW Healthcare, please
                  login to access our premium healthcare products and manage
                  your orders.
                </p>
