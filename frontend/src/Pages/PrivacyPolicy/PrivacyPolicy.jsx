...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy & Policy - SW Healthcare</title>
        <meta
          name="description"
          content="Learn about SW Healthcare's privacy policy and how we collect, use, and protect your personal data. Your privacy is important to us."
        />
      </Helmet>
      ...
      <section class="privacy-policy-section">
        <div class="container">
          ...
          <p>
            At SW Healthcare, we value your privacy and are committed to
          ...
          <ul>
            ...
            <li>To process transactions and manage your medical orders.</li>
            <li>
