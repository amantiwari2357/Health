...
const getWelcomeEmailTemplate = (name) => `
    <div style="font-family: Arial, sans-serif; margin: 0; padding: 0; width: 100%; background-color: #F7F7F7;">
        <table style="max-width: 600px; margin: 50px auto; background: #FFFFFF; border: 1px solid #E8E8E8; border-radius: 10px;">
            <tr>
                <td style="background: #6e84d0; padding: 20px; text-align: center;">
                    <h1 style="color: #FFFFFF; font-size: 24px;">Welcome to SW Health Care</h1>
                </td>
            </tr>
            <tr>
                <td style="padding: 20px;">
                    ...
                    <p style="color: #555555; font-size: 16px; line-height: 1.5; margin: 0;">
                        Thank you for signing up with <strong>SW Health Care</strong>. We are excited to have you on board!
                    </p>
                    <p style="color: #555555; font-size: 16px; line-height: 1.5; margin: 0; margin-top: 10px;">
                        SW Health Care specializes in selling high-quality products like Cow Ghee, Chawanprash, and more. We are committed to providing you with the best products and service.
                    </p>
                </td>
            </tr>
            <tr>
                <td style="padding: 20px;">
                    <p style="color: #555555; font-size: 14px; line-height: 1.5; margin: 0;">
                        If you have any questions, feel free to contact us at <strong>9220442515</strong>.
                    </p>
                    <p style="color: #555555; font-size: 14px; line-height: 1.5; margin: 0; margin-top: 10px;">
                        Best regards,<br>
                        <strong>The SW Health Cares Team</strong>
                    </p>
                </td>
            </tr>
        </table>
...
const createRecord = async (req, res) => {
    ...
    try {
        ...
        await transporter.sendMail({
            from: "swhealthcare17@gmail.com",
            to: email,
            subject: "Welcome to SW Health Care!",
        ...
        <table style="max-width: 600px; margin: 50px auto; background: #FFFFFF; border: 1px solid #E8E8E8; border-radius: 10px;">
            ...
            <tr>
                <td style="padding: 20px;">
                    ...
                    <p style="color: #555555; font-size: 16px; line-height: 1.5; margin: 20px 0;">
                        <a href="${resetLink}" style="color: #6e84d0; text-decoration: none; font-size: 16px;">Reset Password</a>
                    </p>
                    <p style="color: #555555; font-size: 14px; line-height: 1.5; margin: 0;">
            ...
            <tr>
                <td style="padding: 20px;">
                    <p style="color: #555555; font-size: 14px; line-height: 1.5; margin: 0;">
                        Best regards,<br>
                        <strong>The SW Health Care Team</strong>
                    </p>
                </td>
            </tr>
        </table>
...
const forgotPassword = async (req, res) => {
    ...
    try {
        ...
        const resetLink = `https://www.swhealthcares.com/reset-password/${resetToken}`;
